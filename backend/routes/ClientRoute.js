...
const { addOrderValidator } = require("../middleware/validation/orders");
const { addTeamMemberValidator } = require("../middleware/validation/team");
...
app.patch(
  ...
  body("fullname")
    ...
    .not()
    .isEmpty()
    .withMessage("fullname doit être une chaine de caractère"),
  body("livoToken")
    .optional()
    .not()
    .isEmpty()
    .withMessage("livoToken doit être une chaine de caractère"),
  body("isBeginner")
    .optional()
    .not()
    .isEmpty()
    .withMessage("isBeginner doit être une chaine de caractère"),
  verifyTOKEN,
  async (req, res) => {
...
app.get("/client/dashbord/team_member", verifyTOKEN, async (req, res) => {
...
app.get("/client/columnoforder", verifyTOKEN, async (req, res) => {
...
app.get("/client/columnoforder/:id", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetColumnOfOrder({
    id: req.params.id,
    id_user: ExtractUserFromTOKEN(req.token).id,
  });
...
app.post(
  ...
  body("active")
    .not()
    .isEmpty()
    .withMessage("La validité ne doit pas être vide")
    .isBoolean()
...
app.patch(
  ...
  //   .not()
  //   .isEmpty()
  //   .withMessage("alias ne doit pas être vide")
  //   .isLength({ min: 1 })
  //   .withMessage("L'alias doit contenir au moins 3 caracatères"),
  body("isExported")
    .optional()
    .not()
    .isEmpty()
    .withMessage("isExported ne doit pas être vide")
    .isBoolean()
    .withMessage("Le format est invalide"),
  body("active")
    .optional()
    .not()
    .isEmpty()
    .withMessage("active ne doit pas être vide")
    .isBoolean()
    .withMessage("Le format est invalide"),
  async (req, res) => {
    const errors = validationResult(req);
...
app.delete("/client/columnoforder/:id", verifyTOKEN, async (req, res) => {
...
app.post(
  ...
  body("name")
    .isLength({ min: 1 })
    .withMessage("Le nom doit contenir au moins 1 caracatères"),
  body("price")
    .notEmpty()
...
app.get("/client/city", verifyTOKEN, async (req, res) => {
...
app.get("/client/city/:id", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetCity({
    id: req.params.id,
    id_user: ExtractUserFromTOKEN(req.token).id,
  });
...
app.delete("/client/city/:id", verifyTOKEN, async (req, res) => {
...
app.get("/client/team_member", verifyTOKEN, async (req, res) => {
  // console.log(typeof req.query.isHidden)
  var booleanValue =
    req.query.isHidden === "false" ? false : Boolean(req.query.isHidden);
...
//NEW API - Talha
app.get("/client/team_member/list", verifyTOKEN, async (req, res) => {
  var booleanValue =
    req.query.isHidden === "false" ? false : Boolean(req.query.isHidden);

  var response = await ClientServices.GetTeamMemberList({
    id_user: ExtractUserFromTOKEN(req.token).id,
    isHidden: booleanValue,
  });
...
app.get("/client/team_member/:id", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetTeamMember({
    id: req.params.id,
    id_user: ExtractUserFromTOKEN(req.token).id,
  });
...
app.patch(
  ...
  body("isHidden")
    ...
    .not()
    .isEmpty()
    .withMessage("isHidden must be not empty")
    .isBoolean()
    .withMessage("isHidden format is invalid"),
  body("upsell")
    .optional()
    .not()
    .isEmpty()
  ...
  body("can_edit_order")
    ...
    .isBoolean()
    .withMessage("Le format est invalide"),
  body("all_column_access")
    .optional()
    .not()
    .isEmpty()
    .withMessage("all_column_access ne doit pas être vide")
    .isBoolean()
    .withMessage("Le format est invalide"),
  body("all_cities_access")
    .optional()
    .not()
    .isEmpty()
    .withMessage("all_cities_access ne doit pas être vide")
    .isBoolean()
    .withMessage("Le format est invalide"),
  body("all_product_access")
    .optional()
    .not()
    .isEmpty()
    .withMessage("all_page_access ne doit pas être vide")
    .isBoolean()
    .withMessage("Le format est invalide"),
  body("all_page_access")
    .optional()
    .not()
    .isEmpty()
    .withMessage("all_page_access ne doit pas être vide")
  ...
  body("column_access")
    .optional()
    .isArray()
    .withMessage("column_access must be array"),
  body("cities_access")
    .optional()
    .isArray()
    .withMessage("cities_access must be array"),
  body("product_access")
    .optional()
    .isArray()
    .withMessage("product_access must be array"),
  body("page_access")
    .optional()
    .isArray()
    .withMessage("page_access must be array"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
    ...
    var response = await ClientServices.PatchTeamMember({
      ...
      max_order: req.body.max_order,
      plainPassword:
        req.body.password === "yourpassword" ? null : req.body.password,
      salaire: req.body.salaire,
      day_payment: req.body.day_payment,
...
app.delete("/client/team_member/:id", verifyTOKEN, async (req, res) => {
...
app.get("/client/product", verifyTOKEN, async (req, res) => {
  var booleanValue =
    req.query.isHidden === "false" ? false : Boolean(req.query.isHidden);
...
app.get("/client/product/:id", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetProduct({
    id: req.params.id,
    id_user: ExtractUserFromTOKEN(req.token).id,
  });
...
app.post(
  ...
  body("price_selling")
    .notEmpty()
    .withMessage("price_selling must be not empty")
    .isNumeric()
    .withMessage("price_selling format is invalid"),
  body("price_buying")
    .optional()
    .notEmpty()
    .withMessage("price_buying must be not empty")
    .isNumeric()
    .withMessage("price_buying format is invalid"),
  body("price_best_selling")
    .optional()
    .notEmpty()
    .withMessage("price_best_selling must be not empty")
    .isNumeric()
    .withMessage("price_best_selling format is invalid"),
  body("other_charges_array")
    .optional()
    .notEmpty()
    .withMessage("other_charges_array is required")
    .isArray()
    .withMessage("other_charges_array must be array"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
...
app.delete("/client/product/:id", verifyTOKEN, async (req, res) => {
...
app.get("/client/page", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetPage();

  return res.status(response.code).json(response);
});

app.get("/client/stock", verifyTOKEN, async (req, res) => {
...
app.get("/client/stock/:id", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetStock({
    id: req.params.id,
    id_user: ExtractUserFromTOKEN(req.token).id,
  });
...
app.post(
  ...
  body("quantity")
    ...
    .isNumeric()
    .withMessage("quantity format is invalid"),
  body("id_product")
    .notEmpty()
    .withMessage("id_product must be not empty")
    .isNumeric()
    .withMessage("id_product format is invalid"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
...
app.delete("/client/stock/:id", verifyTOKEN, async (req, res) => {
...
app.get("/client/setting", verifyTOKEN, async (req, res) => {
...
app.patch(
  "/client/setting",
  verifyTOKEN,
  body("default_conf_pricing")
    .optional()
    .not()
    .isEmpty()
    .withMessage("default_conf_pricing ne doit pas être vide")
    .notEmpty()
    .withMessage("default_conf_pricing must be not empty")
    .isNumeric()
    .withMessage("default_conf_pricing format is invalid"),
  body("delfault_del_pricing")
    .optional()
    .not()
    .isEmpty()
    .withMessage("delfault_del_pricing ne doit pas être vide")
    .notEmpty()
    .withMessage("delfault_del_pricing must be not empty")
    .isNumeric()
    .withMessage("delfault_del_pricing format is invalid"),
  body("default_time")
    .optional()
    .not()
    .isEmpty()
    .withMessage("default_time ne doit pas être vide")
    .notEmpty()
    .withMessage("default_time must be not empty")
    .isNumeric()
    .withMessage("default_time format is invalid"),
  body("automated_msg")
    .optional()
    .not()
    .isEmpty()
    .withMessage("automated_msg ne doit pas être vide")
    .isLength({ min: 1 })
    .withMessage("Le automated_msg doit contenir au moins 1 caracatères"),
  body("startWrldOrder")
    .optional()
    .not()
    .isEmpty()
    .withMessage("startWrldOrder ne doit pas être vide")
    .isLength({ max: 14 })
    .withMessage("Le startWrldOrder doit contenir au maximum 14 caracatères"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
...
app.patch(
  ...
  body("name")
    .isLength({ min: 3 })
    .withMessage("Le text doit contenir au moins 3 caracatères"),
  body("checked")
    .not()
    .isEmpty()
    .withMessage("checked ne doit pas être vide")
    .isBoolean()
    .withMessage("Le format est invalide"),
  async (req, res) => {
    ...
    await Promise.all(
      statusData.map(async (item) => {
        const result = await ClientServices.PatchStatus({
          id: item.id,
        ...
        if (result.code === 200) response.push(result?.data);
        else
          return res
            .status(result.code)
            .json({ message: `${item?.name} is not exist` });
      })
    );
    return res.status(200).json(response);
  }
...
app.get("/client/status", verifyTOKEN, async (req, res) => {
  const errors = validationResult(req);
  if (!errors.isEmpty())
    return res.status(400).json({ errors: errors.array() });
  ...
  var response = await ClientServices.GetStatus({
    ...
    datefrom: req.query.datefrom,
    dateto: req.query.dateto,
    id_product_array: req.query.id_product_array
      ? [req.query.id_product_array]
      : [],
  });
...
app.delete("/client/status/:id", verifyTOKEN, async (req, res) => {
...
app.get("/client/pertecategorie", verifyTOKEN, async (req, res) => {
...
app.get("/client/pertecategorie/:id", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetPerteCategorie({
    id: req.params.id,
    id_user: ExtractUserFromTOKEN(req.token).id,
  });
...
app.delete("/client/pertecategorie/:id", verifyTOKEN, async (req, res) => {
...
app.get("/client/gaincategorie", verifyTOKEN, async (req, res) => {
...
app.get("/client/gaincategorie/:id", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetGainCategorie({
    id: req.params.id,
    id_user: ExtractUserFromTOKEN(req.token).id,
  });
...
app.delete("/client/gaincategorie/:id", verifyTOKEN, async (req, res) => {
...
app.post(
  ...
  body("id_product")
    ...
    .isNumeric()
    .withMessage("id_product format is invalid"),
  body("id_gain_categorie")
    .notEmpty()
    .withMessage("id_gain_categorie must be not empty")
    .isNumeric()
    .withMessage("id_gain_categorie format is invalid"),
  body("note")
    .isLength({ min: 3 })
  ...
  body("amount")
    ...
    .isFloat()
    .withMessage("amount format is invalid"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
...
app.delete("/client/gain/:id", verifyTOKEN, async (req, res) => {
...
app.post(
  ...
  body("id_product")
    ...
    .isNumeric()
    .withMessage("id_product format is invalid"),
  body("id_perte_categorie")
    .notEmpty()
    .withMessage("id_perte_categorie must be not empty")
    .isNumeric()
    .withMessage("id_perte_categorie format is invalid"),
  body("note").optional(),
  body("dateFrom").isDate().withMessage("Le format de la date est incorrect"),
  body("dateTo").isDate().withMessage("Le format de la date est incorrect"),
  body("amount")
...
app.delete("/client/perte/:id", verifyTOKEN, async (req, res) => {
...
app.get("/client/transaction", verifyTOKEN, async (req, res) => {
...
app.get("/client/detailsofspending", verifyTOKEN, async (req, res) => {
...
app.post(
  "/client/integratesheet",
  verifyTOKEN,
  body("spreadsheetId")
    .isLength({ min: 3 })
    .withMessage("spreadsheetId doit contenir au moins 3 caracatères"),
  body("name")
    .isLength({ min: 3 })
    .withMessage("name doit contenir au moins 3 caracatères"),
  body("range")
    .isLength({ min: 3 })
    .withMessage("range doit contenir au moins 3 caracatères"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
...
app.get("/client/integratesheet", verifyTOKEN, async (req, res) => {
  const errors = validationResult(req);
  if (!errors.isEmpty())
    return res.status(400).json({ errors: errors.array() });
...
app.get("/client/pack", verifyTOKEN, async (req, res) => {
...
app.get("/client/ads", verifyTOKEN, async (req, res) => {
...
app.get("/client/annoucement", verifyTOKEN, async (req, res) => {
...
app.post("/client/order", verifyTOKEN, addOrderValidator, async (req, res) => {
  ...
  //this is addnind orders of sheet into database
  const sheetResponse = await IntegrateServices.GetSheet({
    id_user: ExtractUserFromTOKEN(req.token).id,
  });
  ...
  var response = await ClientServices.AddOrder({
    ...
    id_user: ExtractUserFromTOKEN(req.token).id,
    userWhoPostedOrder: ExtractUserFromTOKEN(req.token),
  });

  return res.status(response.code).json(response);
});

app.get("/client/order", verifyTOKEN, async (req, res) => {
...
app.get("/client/order/history", verifyTOKEN, async (req, res) => {
...
app.get("/client/order/sheet", verifyTOKEN, async (req, res) => {
  const response = await IntegrateServices.GetSheet({
    id_user: ExtractUserFromTOKEN(req.token).id,
  });

  // console.log('---------client/order/sheet response---------');
...
app.patch(
  ...
  body("date")
    .optional()
    .isDate()
    .withMessage("Le format de la date est incorrect"),
  body("reportedDate")
    .optional()
    .isDate()
    .withMessage("Le format de la date est incorrect"),
  body("nom")
    .optional()
    .isLength({ min: 0 })
    .withMessage("La nom doit contenir au moins 3 caracatères"),
  body("telephone")
    .optional()
    .isLength({ min: 8 })
  ...
  body("adresse")
    .optional()
    .isLength({ min: 0 })
    .withMessage("L'adresse doit contenir au moins 3 caracatères"),
  body("shipping")
    .optional()
    .isLength({ min: 3 })
    .withMessage("Le shipping doit contenir au moins 3 caracatères"),
  body("message")
    .optional()
    .isLength({ min: 0 })
    .withMessage("Le message doit contenir au moins 3 caracatères"),
  body("source")
    .optional()
    .isLength({ min: 0 })
  ...
  body("variant")
    .optional()
    .isLength({ min: 3 })
    .withMessage("variant doit contenir au moins 3 caracatères"),
  body("updownsell")
    .optional()
    .isLength({ min: 3 })
  ...
  body("last_action")
    .optional()
    .isLength({ min: 3 })
    .withMessage("last_action doit contenir au moins 3 caracatères"),
  body("changer")
    .optional()
    .isLength({ min: 3 })
  ...
  body("prev_id_team")
    .optional()
    .notEmpty()
    .withMessage("prev_id_team must be not empty")
    .isNumeric()
    .withMessage("prev_id_team format is invalid"),
  body("id_team")
    .optional({ nullable: true })
    .notEmpty()
    .withMessage("id_team must be not empty")
    .isNumeric()
    .withMessage("id_team format is invalid"),
  body("id_city")
    .optional()
    .notEmpty()
...
app.post(
  ...
  body("new_id_team")
    .notEmpty()
    .withMessage("new_id_team must be not empty")
    .isNumeric()
    .withMessage("new_id_team format is invalid"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
...
app.get("/client/paymentmethod", verifyTOKEN, async (req, res) => {
...
app.get("/client/adminbankinformation", verifyTOKEN, async (req, res) => {
...
app.post(
  ...
  body("code")
    .isLength({ min: 3 })
    .withMessage("Le code doit contenir au moins 3 caracatères"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
...
app.get("/client/account", verifyTOKEN, async (req, res) => {
...
app.get("/client/lasypayment", verifyTOKEN, async (req, res) => {
...
app.get("/client/order/count", verifyTOKEN, async (req, res) => {
...
app.delete("/client/variant/:id", verifyTOKEN, async (req, res) => {
...
app.get("/client/variant", verifyTOKEN, async (req, res) => {
...
app.get("/client/paiement_dashbord", verifyTOKEN, async (req, res) => {
...
app.post(
  ...
  body("value")
    .notEmpty()
    .withMessage("value must be not empty")
    .isNumeric()
...
app.delete("/client/goal", verifyTOKEN, async (req, res) => {
  const errors = validationResult(req);
  if (!errors.isEmpty())
    return res.status(400).json({ errors: errors.array() });
...
app.get("/client/goal", verifyTOKEN, async (req, res) => {
  const errors = validationResult(req);
  if (!errors.isEmpty())
    return res.status(400).json({ errors: errors.array() });
...
app.get("/client/order/export", verifyTOKEN, async (req, res) => {
  var response = await ClientServices.GetOrderExportModel({
    id_user: ExtractUserFromTOKEN(req.token).id,
    id_orders:
      req.query.id_orders != "[]" && req.query.id_orders
        ? JSON.parse(req.query.id_orders)
        : null,
  });
...
app.post(
  "/client/verifyOTP",
  body("code").notEmpty().withMessage("code must be not empty"),
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty())
      return res.status(400).json({ errors: errors.array() });
...
app.get("/client/shippingcompanie", verifyTOKEN, async (req, res) => {
...
app.get("/client/getallid", verifyTOKEN, async (req, res) => {
...
app.get("/client/order/byid", verifyTOKEN, async (req, res) => {
...
app.get("/client/order/comment", verifyTOKEN, async (req, res) => {
...
app.post(
  ...
  body("description")
    .isLength({ min: 3 })
    .withMessage("La description doit contenir au moins 3 caracatères"),
...
app.get("/client/support", verifyTOKEN, async (req, res) => {
...
app.get("/client/support/msg/:id", verifyTOKEN, async (req, res) => {
