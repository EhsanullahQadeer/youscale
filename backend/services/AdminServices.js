...
class AdminServices {
    ...
    static async GetDashboard({ id_user, id_admin, id_team, status_clt, dateFrom, dateTo, useDate }) {
        ...
        try {
            const data = {
                costPerLead: await this.getCostPerLead(params) || [],
                costPerActive: await this.getCostPerActive(params) || [],
                costPerVerifiedClient: await this.getCostPerVerifiedClient(params) || [],
                rateLeadPayed: await this.getRateLeadPayed(params) || [],
                loyalClient: await this.getLoyalClient(params) || [],
                earningNet: await this.getEarningNet(params) || [],
                spending: await this.getSpending(params) || [],
                chffAffaire: await this.getChiffreAffaire(params) || [],
                orderStatistic: await this.getOrderStatistics(params) || [],
                clientStatistic: await this.getClientStatistics(params) || [],
                clientStatisticRate: await this.getClientStatisticsRate(params) || [],
                orderReport: await this.getOrderReport(params) || [],
                earningReport: await this.getEarningReport(params) || [],
                costReport: await this.getCostReport(params) || []
            };

            const nullCheck = Object.values(data).some(val => val === null);
            if (nullCheck) {
    ...
    static async AddClient({ fullname, plainPassword, email, telephone, role, id_admin, message }) {
        ...
        try {
            ...
            const columnOfOrderData = [
                ...
                { 'name': 'Quantity', 'active': true, 'id_user': clientSaved.id },
