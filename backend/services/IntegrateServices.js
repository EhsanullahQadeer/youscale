...
class IntegrateServices {
    ...
    static async #findColumnOfOrder(id_user) {
        ...
        //console.log(columnFound)

        columnFound = columnFound.map(x => x.get({ plain: true }))

        columnFound.forEach(
            (column) => {
                // const formattedValue = column.alias.replace(/_/g, " ");
                            ...
                            if (sheetExist === null) {
                                ...
                                if (id_product_array.length > 0) {
                                    ...
                                    if (id_city === null || !data[i][ColumnAlias['Prix']] || !data[i][ColumnAlias['Telephone']] || !data[i][ColumnAlias['Order id']]) {
                                        ...
                                        // console.log(id_city)
                                        // console.log(data[i][ColumnAlias['Prix']])
                                        // console.log(data[i][ColumnAlias['Telephone']])
                                        console.log([ColumnAlias['Order id']])
                                        console.log(data[i][ColumnAlias['Order id']])
                                        ...
                                        //console.log('----------add order responce----------')
                                        //console.log(rs);
